...
const ARTICLES = [
  ...
  {
    id: 'best-folder-structure-for-files',
    title: 'The Best Folder Structure for Organizing Files (With Examples)',
    excerpt: 'A clear, proven folder structure for your documents, with copy-ready examples. Learn why deep folders fail, how to name them, and what to do instead.',
    date: 'June 21, 2026',
    readTime: '8 min read',
    category: 'Guides',
  },
  {
    id: 'what-is-an-ai-file-organizer',
    title: 'What Is an AI File Organizer? (And How It Actually Works)',
    excerpt: 'An AI file organizer reads your files instead of just their names. Here is what that means, how it works step by step, and whether you actually need one.',
    date: 'June 21, 2026',
    readTime: '8 min read',
    category: 'Product',
  },
  {
    id: 'how-to-organize-photos-on-computer',
    title: 'How to Organize Photos on Your Computer (Without the Overwhelm)',
    excerpt: 'Thousands of photos and zero structure? A simple, lasting system to organize photos by date and event, remove duplicates, and find any shot fast.',
    date: 'June 21, 2026',
    readTime: '8 min read',
    category: 'Guides',
  },
  {
    id: 'how-to-organize-work-files',
    title: 'How to Organize Work Files and Projects (A Practical System)',
    excerpt: 'Drowning in work documents across clients and projects? A practical, project-first system that survives deadlines, version chaos, and shared drives.',
    date: 'June 21, 2026',
    readTime: '8 min read',
    category: 'Productivity',
  },
  {
    id: 'how-to-organize-receipts-and-tax-documents',
    title: 'How to Organize Receipts, Invoices, and Tax Documents',
    excerpt: 'Turn tax-season chaos into a ten-minute search. A simple year-by-year system for receipts and tax documents, plus how to find any scanned receipt instantly.',
    date: 'June 21, 2026',
    readTime: '7 min read',
    category: 'Productivity',
  },
